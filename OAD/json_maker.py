...
def make_contents(path):
    ...
    for filename in os.listdir(path):
        if 'validation' in filename or 'test_0001292' in filename:
            continue
...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='baseline')
    parser.add_argument('--file_name', type=str, default='baseline.json')
    parser.add_argument('--save_path', type=str, default='proposals')
    ...
    with open(osp.join(savepath, filename), 'w') as fp:
